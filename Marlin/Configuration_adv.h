...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 1.00        // (mm) Compression length applying to all extruders
  #endif
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_3_DESC "Boot Mode (M997)"
  #define MAIN_MENU_ITEM_3_GCODE "M997" // Enter Boot Mode (for firmware flashing)
...
// #define CUSTOM_MENU_CONFIG
  ...
  #define CUSTOM_MENU_CONFIG_SCRIPT_DONE "User Script Done"
  ...
  #define CONFIG_MENU_ITEM_2_DESC "Home & Info"
